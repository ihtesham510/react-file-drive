...
const Header = () => {
	...
	return (
		<div className='flex sticky lg:static top-0 z-50 lg:bg-background backdrop-blur py-4 items-center mx-2 lg:mx-5 sm:h-20 justify-between sm:justify-between'>
			...
			<div className='flex justify-end items-center gap-5 w-[400px] mr-2'>

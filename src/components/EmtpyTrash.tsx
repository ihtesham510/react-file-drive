const EmtpyTrash = () => {
	return (
		<div className=' w-full justify-center flex-col items-center flex '>
			...
			>
				<path
					id='a935b196-91fc-4d65-bd04-49275a33d175-642'
					data-name='Path 1'
				...
				/>
				<path
					id='af9a6d89-7824-4af5-a475-6980c18ad0f3-643'
					data-name='Path 2'
				...
				/>
				<path
					id='ae138407-70d7-43ff-b006-9d3240c337f6-644'
					data-name='Path 3'
				...
				/>
				<path
					id='a7d931fe-d47e-4aa5-ae01-a0d26a3448cc-645'
					data-name='Path 4'
				...
				/>
				<path
					id='b274f1e0-b558-44b1-a0b2-dcd77bbddb14-646'
					data-name='Path 5'
				...
				/>
				<path
					id='bca7d782-7e31-494e-97b0-f49b8df7894d-647'
					data-name='Path 8'
				...
				/>
				<path
					id='b31113e7-cae2-4653-b248-af5e4acb0a6c-648'
					data-name='Path 10'
				...
				<g id='b91459ce-423d-4e92-a857-d0ba85dc07c7' data-name='Group 6'>
					<path
						id='bc369f15-2cd9-428d-9eec-3a8fd8cc1bba-649'
						data-name='Path 111'
					...
					/>
					<path
						id='fafca8b8-1a63-4513-a3fa-e64917847011-650'
						data-name='Path 112'
					...
					/>
					<path
						id='a38ea43e-f1b1-406e-84c8-61e7480f01b4-651'
						data-name='Path 113'
					...
					/>
					<path
						id='b5ba90e2-8a51-4a77-95c4-5b486c8770ec-652'
						data-name='Path 114'
					...
					/>
					<path
						id='b1536285-e66e-494f-8c4f-a2304265e4c3-653'
						data-name='Path 115'
					...
					/>
					<path
						id='acd6249e-4699-4411-813c-091b3a750afe-654'
						data-name='Path 116'
					...
					/>
					<path
						id='ece4d731-f277-435f-bbc1-e3b70679d22f-655'
						data-name='Path 117'
					...
					/>
					<path
						id='b91f5bf0-a8c5-41a2-a26e-8e2fd84207c6-656'
						data-name='Path 118'
					...
					/>
					<path
						id='b0b7866d-f3ba-460a-97cc-8103175b89de-657'
						data-name='Path 119'
					...
					/>
					<path
						id='e83e2647-99b5-4c80-ac3e-9e5d1f9bc81d-658'
						data-name='Path 120'
				...
				<g id='ff061cc6-72bd-494d-9c36-32e4a4020cd7' data-name='Group 4'>
					<path
						id='bc404282-8d4f-43f7-bc12-02f97785eba1-659'
						data-name='Path 81'
					...
					/>
					<path
						id='ae4af9f3-88ec-4cab-9b9e-a4fc234f7062-660'
						data-name='Path 82'
					...
					/>
					<path
						id='fe48f3fd-992f-41c2-af3b-c30882e26a16-661'
						data-name='Path 83'
					...
					/>
					<path
						id='e216638f-22ba-49ea-a46c-300c78c4e875-662'
						data-name='Path 84'
					...
					/>
					<path
						id='ee43e3d8-5f22-4b53-a964-043fec166479-663'
						data-name='Path 85'
			...
			<p className='text-2xl font-mono'>Empty Trash</p>
		</div>
	)
}

export default EmtpyTrash
